...
// some boards are omitted for sites due to search being disabled on those websites
// archived.moe is limited to boards not covered by other sites
const liveSitesAndBoards = {
  ...
  "archive.palanq.win": /\/(bant|c|con|e|i|n|news|out|p|pw|qst|toy|vip|vp|vt|w|wg|wsr)\//,
  "archived.moe": /\/(asp|b|can|cock|fap|fitlit|gd|mlpol|mo|mtv|outsoc|po|spa|vint)\//, // thumbnails only, except for po and gd which have full images
  "archiveofsins.com": /\/(h|hc|hm|i|lgbt|r|s|soc|t|u)\//,
  "boards.fireden.net": /\/(cm|co|ic|sci|y)\//, // omitted: v. vip
  "desuarchive.org": /\/(a|aco|an|c|cgl|co|d|fit|g|his|int|k|m|mlp|mu|q|qa|r9k|tg|trash|vr)\//,
  "eientei.xyz": /\/(xs)\//, // omitted: 3, i, sci
...
const liveSitesAndBoardsNoFilter = {
  ...
  "desuarchive.org": /\/(a|aco|an|c|cgl|co|d|fit|g|gif|his|int|k|m|mlp|mu|q|qa|r9k|tg|trash|vr)\//,
  "eientei.xyz": /\/(3|i|sci|xs)\//,
